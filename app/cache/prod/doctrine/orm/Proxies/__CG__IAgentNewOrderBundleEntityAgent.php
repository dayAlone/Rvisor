 ...
 */
class Agent extends \IAgent\NewOrderBundle\Entity\Agent implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'code', 'active', 'comment', 'login', 'name', 'password', 'phone', 'email', 'lastUpdate', 'parentUserFk', 'workingTimeFk', 'device');
    }
