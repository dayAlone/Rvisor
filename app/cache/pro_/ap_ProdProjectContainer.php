...
class ap_ProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Users/slider/Documents/HTML/Iagent/path/app/cache/pro_/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/Users/slider/Documents/HTML/Iagent/path/app/cache/pro_/assetic/config'), false)));
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/Users/slider/Documents/HTML/Iagent/path/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
        return $instance;
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/Users/slider/Documents/HTML/Iagent/path/app/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_259f04c4e3ef291fa2c53403bc428513');
        $c = new \Doctrine\Common\Cache\ApcCache();
        $c->setNamespace('sf2orm_default_259f04c4e3ef291fa2c53403bc428513');
        $d = new \Doctrine\Common\Cache\ApcCache();
        $d->setNamespace('sf2orm_default_259f04c4e3ef291fa2c53403bc428513');
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => '/Users/slider/Documents/HTML/Iagent/path/src/IAgent/NewOrderBundle/Entity', 1 => '/Users/slider/Documents/HTML/Iagent/path/src/IAgent/UserBundle/Entity'));
        ...
        $g->setProxyDir('/Users/slider/Documents/HTML/Iagent/path/app/cache/pro_/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/Users/slider/Documents/HTML/Iagent/path/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/Users/slider/Documents/HTML/Iagent/path/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Users/slider/Documents/HTML/Iagent/path/app/cache/pro_/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/Users/slider/Documents/HTML/Iagent/path/app/cache/pro_/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Users/slider/Documents/HTML/Iagent/path/app/cache/pro_/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/Users/slider/Documents/HTML/Iagent/path/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/Users/slider/Documents/HTML/Iagent/path/app/cache/pro_/translations', 'debug' => false));
    }
    protected function getTwigService()
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/Users/slider/Documents/HTML/Iagent/path/app/cache/pro_/twig', 'charset' => 'UTF-8', 'paths' => array()));
        $instance->addExtension(new \Symfony\Bundle\SecurityBundle\Twig\Extension\LogoutUrlExtension($this->get('templating.helper.logout_url')));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\SecurityExtension($this->get('security.context', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\TranslationExtension($this->get('translator')));
        $instance->addExtension(new \Symfony\Bundle\TwigBundle\Extension\AssetsExtension($this));
        $instance->addExtension(new \Symfony\Bundle\TwigBundle\Extension\ActionsExtension($this));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/Users/slider/Documents/HTML/Iagent/path/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Users/slider/Documents/HTML/Iagent/path/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/Users/slider/Documents/HTML/Iagent/path/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/Users/slider/Documents/HTML/Iagent/path/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/Users/slider/Documents/HTML/Iagent/path/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/Users/slider/Documents/HTML/Iagent/path/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/Users/slider/Documents/HTML/Iagent/path/src/IAgent/NewOrderBundle/Resources/views', 'NewOrder');
        $instance->addPath('/Users/slider/Documents/HTML/Iagent/path/src/IAgent/UserBundle/Resources/views', 'User');
        $instance->addPath('/Users/slider/Documents/HTML/Iagent/path/app/Resources/views');
        $instance->addPath('/Users/slider/Documents/HTML/Iagent/path/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
        return $instance;
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Users/slider/Documents/HTML/Iagent/path/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Users/slider/Documents/HTML/Iagent/path/app/cache/pro_');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/Users/slider/Documents/HTML/Iagent/path/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Users/slider/Documents/HTML/Iagent/path/app',
            'kernel.environment' => 'prod',
            'kernel.debug' => false,
            'kernel.name' => 'ap_',
            'kernel.cache_dir' => '/Users/slider/Documents/HTML/Iagent/path/app/cache/pro_',
            'kernel.logs_dir' => '/Users/slider/Documents/HTML/Iagent/path/app/logs',
            ...
            'session.save_path' => '/Users/slider/Documents/HTML/Iagent/path/app/cache/pro_/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/Users/slider/Documents/HTML/Iagent/path/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            ...
            'router.resource' => '/Users/slider/Documents/HTML/Iagent/path/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Users/slider/Documents/HTML/Iagent/path/app/cache/pro_/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => '/Users/slider/Documents/HTML/Iagent/path/app/cache/pro_/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/Users/slider/Documents/HTML/Iagent/path/app/cache/pro_/assetic',
            ...
            'assetic.read_from' => '/Users/slider/Documents/HTML/Iagent/path/app/../web',
            'assetic.write_to' => '/Users/slider/Documents/HTML/Iagent/path/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/Users/slider/Documents/HTML/Iagent/path/app/cache/pro_/doctrine/orm/Proxies',
