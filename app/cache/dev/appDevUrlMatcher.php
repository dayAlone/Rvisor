...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
            ...
            if (0 === strpos($pathinfo, '/step')) {
                if (0 === strpos($pathinfo, '/step2')) {
                    ...
                    if (rtrim($pathinfo, '/') === '/step2') {
                        ...
                        return array (  'query' => NULL,  '_controller' => 'IAgent\\NewOrderBundle\\Controller\\DefaultController::step2Action',  '_route' => 'step2',);
                    }

                    // iagent_neworder_default_step2
                    if (0 === strpos($pathinfo, '/step2/search') && preg_match('#^/step2/search(?:/(?P<query>[^/]++))?$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'iagent_neworder_default_step2')), array (  'query' => NULL,  '_controller' => 'IAgent\\NewOrderBundle\\Controller\\DefaultController::step2Action',));
                    }
        ...
        // step2_info
        if (0 === strpos($pathinfo, '/step2/info') && preg_match('#^/step2/info(?:/(?P<query>[^/]++))?$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'step2_info')), array (  'query' => NULL,  '_controller' => 'IAgent\\NewOrderBundle\\Controller\\DefaultController::step2info',));
        }
