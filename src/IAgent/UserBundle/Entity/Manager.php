...
class Manager
{
    ...
    /**
     * @var \IAgent\UserBundle\Entity\UserType
     *
     * @ORM\ManyToOne(targetEntity="IAgent\UserBundle\Entity\UserType")
     * @ORM\JoinColumns({
     ...
     * Set userTypeFk
     *
     * @param \IAgent\UserBundle\Entity\UserType $userTypeFk
     * @return Manager
     */
    public function setUserTypeFk(\IAgent\UserBundle\Entity\UserType $userTypeFk = null)
    {
     ...
     * Get userTypeFk
     *
     * @return \IAgent\UserBundle\Entity\UserType 
     */
